...
<section class="page-section page-chauffeurs">
	<div class="container">
		<h2 class="heading-1">Chauffeurs</h2>
		<div class="row">
			...
			<?php foreach ($this->items as $key => $result):?>
				...
				<div class="col-md-4">
					<div class="item-box">
						<a class="image"
							 href="<?php echo JRoute::_('index.php?option=com_beseated&view=chauffeurinformation&chauffeur_id='.$result->chauffeur_id.'&Itemid='.$menuItem->id) ?>"
							 style="background-image: url(<?php echo $image ? JUri::base().'images/beseated/'.$image : 'images/bcted/default/banner.png' ?>)">
						</a>
						<h3 class="heading-3">
							<span class="text">
								<?php echo $result->chauffeur_name; ?>
							</span>
							<span class="rating">
