...
<section class="page-section page-protections">
	<div class="container">
		<h2 class="heading-1">Protections</h2>
		<div class="row">
			<?php $menuItem = $menu->getItems( 'link', 'index.php?option=com_beseated&view=protectioninformation', true );?>
			<?php foreach ($this->items as $key => $result):?>
				<?php $image = $result->thumb_image ?: $result->image; ?>
				<div class="col-md-4">
					<div class="item-box">
						<a class="image"
							 href="<?php echo JRoute::_('index.php?option=com_beseated&view=protectioninformation&protection_id='.$result->protection_id.'&Itemid='.$menuItem->id) ?>"
							 style="background-image: url(<?php echo $image ? JUri::base().'images/beseated/'.$image : 'images/bcted/default/banner.png' ?>)">
						</a>
						<h3 class="heading-3">
							<span class="text">
								<?php echo $result->protection_name; ?>
							</span>
							<span class="rating">
