		...
		<div class="container<?php echo ($params->get('fluidContainer') ? '-fluid' : ''); ?>">
			...
			<header class="header" role="banner">
				<div class="header-inner clearfix" id="header-wrapper">
					...
					require_once(JPATH_SITE.'/components/com_bcted/helpers/bcted.php');
					...
					if(in_array($bctParams->club, $groups))
					{
						$accessLevel = BctedHelper::getGroupAccessLevel($bctParams->club);
					}
					else if(in_array($bctParams->service_provider, $groups))
					{
						$accessLevel = BctedHelper::getGroupAccessLevel($bctParams->service_provider);
					}
					else if(in_array($bctParams->guest, $groups))
					{
