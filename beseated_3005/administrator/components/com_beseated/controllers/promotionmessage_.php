 ...
 * @since  0.0.1
 */
class BeseatedControllerPromotionMessage extends JControllerAdmin
{
	 ...
	 * @since   0.0.1
	 */
	public function getModel($name = 'PromotionMessage', $prefix = 'BeseatedModel', $config = array('ignore_request' => true))
	{
