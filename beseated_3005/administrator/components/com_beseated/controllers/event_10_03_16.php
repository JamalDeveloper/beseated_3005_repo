	...
	public function uploadTicketTypeImages($event_id,$file)
	{
		...
		if(!empty($imageName))
		{
			if ((($file["type"] == "image/gif") || ($file["type"] == "image/jpeg") || ($file["type"] == "image/jpg") || ($file["type"] == "image/png")) && in_array($extension, $allowedExts))
			{
				...
				if(!JFolder::exists(JPATH_ROOT . "images/beseated/Event/".$event_id."/ticket_type"))
				{
					JFolder::create(JPATH_ROOT . "images/beseated/Event/".$event_id."/ticket_type");
				}

				$img = $imgnm . "_" . rand(0, 99999) . "." . $ext;
				$dest = "../images/beseated/Event/$event_id/ticket_type/$img";
