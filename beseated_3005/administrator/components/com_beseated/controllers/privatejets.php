 ...
 * @since  0.0.1
 */
class BeseatedControllerPrivateJets extends JControllerAdmin
{
	/**
	 * Proxy for getModel.
	 *
	 ...
	 * @since   0.0.1
	 */
	public function getModel($name = 'PrivateJet', $prefix = 'BeseatedModel', $config = array('ignore_request' => true))
	{
