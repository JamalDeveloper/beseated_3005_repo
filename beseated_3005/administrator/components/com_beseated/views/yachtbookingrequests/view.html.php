 ...
 * @since  0.0.1
 */
class BeseatedViewYachtBookingRequests extends JViewLegacy
{
	/**
	...
	function display($tpl = null)
	{
		...
		BeseatedHelper::addSubmenu('yachtbookingrequests');
	...
	protected function addToolBar()
	{
		...
		JToolBarHelper::title($title, 'Yacht Booking Requests');
		JToolBarHelper::addNew('yachtbookingrequest.add','Add Request');
