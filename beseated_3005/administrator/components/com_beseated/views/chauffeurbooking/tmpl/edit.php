...
<script type="text/javascript">
    function initialize()
    {
        ...
        jQuery(document).ready(function()
        {
            ...
            jQuery.ajax({
                        url:'index.php?option=com_beseated&task=chauffeurbooking.getChauffeurServcies',
                        type: "POST",
                        data: {
    ...
    Joomla.submitbutton = function(task)
    {
        ...
        if(task != 'chauffeurbooking.cancel')
        {
            if (isValid)
            {
                if (useDate < fullDate)
...
<form action="<?php echo JRoute::_('index.php?option=com_beseated&view=chauffeurbooking&layout=edit&chauffeur_booking_id=' . (int) $this->item->chauffeur_booking_id); ?>"
    method="post" name="adminForm" id="adminForm" >
    <div class="form-horizontal">
        <fieldset>
            <div class="span12">
                <legend><?php echo JText::_('COM_BESEATED_CHAUFFEUR_DETAIL'); ?></legend>
