 ...
 * @since  0.0.1
 */
class BeseatedViewRewardBookings extends JViewLegacy
{
	/**
	...
	function display($tpl = null)
	{
		...
		BeseatedHelper::addSubmenu('rewardbookings');
	...
	{
		$title = JText::_('COM_BESEATED_MANAGE_REWARD_BOOKINGS');
		...
		JToolBarHelper::title($title, 'Reward Bookings');
