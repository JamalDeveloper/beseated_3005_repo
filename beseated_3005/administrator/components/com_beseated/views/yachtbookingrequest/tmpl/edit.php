...
<script type="text/javascript">
    function initialize()
    {
        ...
        jQuery(document).ready(function()
        {
            ...
            jQuery.ajax({
                        url:'index.php?option=com_beseated&task=yachtbookingrequest.getYachtServcies',
                        type: "POST",
                        data: {
                            'yacht_id': yacht_id
                        }
    ...
    Joomla.submitbutton = function(task)
    {
        ...
        if(task != 'yachtbookingrequest.cancel')
        {
            if (isValid)
            {
                if (useDate < fullDate)
...
<form action="<?php echo JRoute::_('index.php?option=com_beseated&view=yachtbookingrequest&layout=edit&yacht_booking_id=' . (int) $this->item->yacht_booking_id); ?>"
    method="post" name="adminForm" id="adminForm" >
    <div class="form-horizontal">
        <fieldset>
            <div class="span12">
                <legend><?php echo JText::_('COM_BESEATED_YACHT_BOOKING_REQUEST_DETAIL'); ?></legend>
