 ...
 * @since  0.0.1
 */
class BeseatedViewConcierges extends JViewLegacy
{
	/**
	...
	function display($tpl = null)
	{
		...
		BeseatedHelper::addSubmenu('concierges');
	...
	{
		$title = JText::_('COM_BESEATED_MANAGE_CONCIERGE');
		...
		JToolBarHelper::title($title, 'concierges');
