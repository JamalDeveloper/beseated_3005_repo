 ...
 * @since  0.0.1
 */
class BeseatedViewChauffeurBookingRequests extends JViewLegacy
{
	/**
	...
	function display($tpl = null)
	{
		...
		BeseatedHelper::addSubmenu('chauffeurbookingrequests');
	...
	protected function addToolBar()
	{
		...
		JToolBarHelper::title($title, 'Chauffeur Booking Requests');
		JToolBarHelper::addNew('chauffeurbookingrequest.add','Add Request');
