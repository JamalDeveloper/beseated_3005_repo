    ...
    jQuery(document).ready(function()
    {
        jQuery("#addTicketTypeZone").click(function()
        {
            ...
            var html =  '<div id="container' + rand + '"><input type="button" name="container' + rand + '" id="rgm" class="btn btn-danger" style="float:right;margin-right:562px;" value="Remove">';
                ...
                html += '<input type="text" name="ticket_type[]" id="ticket_type"   placeHolder="Enter Ticket Type" required>&nbsp;';
                html += '<input type="text" name="ticket_zone[]" id="ticket_zone"   placeHolder="Enter Zone" required>&nbsp;';
                html += '<input type="text" name="ticket_price[]" id="ticket_price"  placeHolder="Enter Price" required>';
