 ...
 * @since  0.0.1
 */
class BeseatedViewProtectionBookingRequests extends JViewLegacy
{
	/**
	...
	function display($tpl = null)
	{
		...
		BeseatedHelper::addSubmenu('protectionbookingrequests');
	...
	protected function addToolBar()
	{
		...
		JToolBarHelper::title($title, 'Protection Booking Requests');
		JToolBarHelper::addNew('protectionbookingrequest.add','Add Request');
		//JToolBarHelper::addNew('booking.add','Add Booking');
