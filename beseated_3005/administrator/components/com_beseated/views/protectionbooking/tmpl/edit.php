...
<script type="text/javascript">
    function initialize()
    {
        ...
        jQuery(document).ready(function()
        {
            ...
            jQuery.ajax({
                        url:'index.php?option=com_beseated&task=protectionbooking.getProtectionServcies',
                        type: "POST",
                        data: {
     ...
     Joomla.submitbutton = function(task)
    {
        ...
        if(task != 'protectionbooking.cancel')
        {
            if (isValid)
            {
                if (useDate < fullDate)
...
<form action="<?php echo JRoute::_('index.php?option=com_beseated&view=protectionbooking&layout=edit&protection_booking_id=' . (int) $this->item->protection_booking_id); ?>"
    method="post" name="adminForm" id="adminForm" >
    <div class="form-horizontal">
        <fieldset>
            <div class="span12">
                <legend><?php echo JText::_('COM_BESEATED_PROTECTION_BOOKING_DETAIL'); ?></legend>
