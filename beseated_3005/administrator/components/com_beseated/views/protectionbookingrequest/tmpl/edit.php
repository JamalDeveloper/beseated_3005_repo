...
<script type="text/javascript">
    function initialize()
    {
        ...
        google.maps.event.addListener(autocomplete, 'place_changed', function() {
         ...
         jQuery("#jform_total_guard,#jform_total_hours").keydown(function (e) {
        ...
        jQuery(document).ready(function()
        {
            ...
            protection_id = jQuery("#jform_protection_id").val();
            jQuery.ajax({
                        url:'index.php?option=com_beseated&task=protectionbookingrequest.getProtectionServcies',
                        type: "POST",
                        data: {
            ...
            jQuery("#jform_protection_id").change(function()
            {
                protection_id = jQuery("#" + this.id).val();
                setServiceHours();
        ...
        function setServiceHours()
        {
            setTimeout(function()
            {
             ...
             jQuery.ajax({
                        url:'index.php?option=com_beseated&task=protectionbooking.getServiceHour',
                        type: "POST",
                        data: {
    ...
    Joomla.submitbutton = function(task)
    {
        ...
        if(task != 'protectionbookingrequest.cancel')
        {
            if (isValid)
            {
                if (useDate < fullDate)
...
<form action="<?php echo JRoute::_('index.php?option=com_beseated&view=protectionbookingrequest&layout=edit&protection_booking_id=' . (int) $this->item->protection_booking_id); ?>"
    method="post" name="adminForm" id="adminForm" >
    <div class="form-horizontal">
        <fieldset>
            <div class="span12">
                <legend><?php echo JText::_('COM_BESEATED_PROTECTION_REQUEST_DETAIL'); ?></legend>
                ...
                <div class="span8">
                    ...
                    <div class="control-group">
                        <div class="control-label"><?php echo $this->form->getLabel('protection_id'); ?></div>
                        <div class="controls"><?php echo $this->form->getInput('protection_id'); ?></div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        <div class="control-label"><?php echo $this->form->getLabel('meetup_location'); ?></div>
                        <div class="controls"><?php echo $this->form->getInput('meetup_location'); ?></div>
                    </div>
                    <!-- <div class="control-group">
                        <div class="control-label"><?php //echo $this->form->getLabel('booking_currency_code'); ?></div>
                        <div class="controls"><?php //echo $this->form->getInput('booking_currency_code'); ?></div>
                    </div> -->
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        <div class="control-label"><?php echo $this->form->getLabel('total_guard'); ?></div>
                        <div class="controls"><?php echo $this->form->getInput('total_guard'); ?></div>
                    </div>
                    <div class="control-group">
