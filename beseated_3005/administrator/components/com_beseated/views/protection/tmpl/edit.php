...
<form action="<?php echo JRoute::_('index.php?option=com_beseated&view=protection&layout=edit&protection_id=' . (int) $this->item->protection_id); ?>"
    method="post" name="adminForm" id="adminForm">
    <div class="form-horizontal">
        <fieldset>
            <div class="span12">
                <legend><?php echo JText::_('COM_BESEATED_PROTECTION_DETAIL'); ?></legend>
                ...
                <div class="control-group">
                    <div class="control-label"><?php echo $this->form->getLabel('protection_name'); ?></div>
                    <div class="controls"><?php echo $this->form->getInput('protection_name'); ?></div>
                </div>
                <div class="control-group">
