...
/**
 * Beseated Venues View
 *
 * @since  0.0.1
 */
class BeseatedViewVenues extends JViewLegacy
{
	/**
	 * Display the Venues view
	 *
	...
	function display($tpl = null)
	{
		...
		BeseatedHelper::addSubmenu('venues');

		// Get data from the model
		$this->items      = $this->get('Items');
		$this->state      = $this->get('State');
		$this->venues     = $this->get('Venues');
	...
	{
		$title = JText::_('COM_BESEATED_MANAGE_VENUES');
		...
		JToolBarHelper::title($title, 'Venues');
