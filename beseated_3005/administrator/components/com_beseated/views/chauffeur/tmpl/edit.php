...
<form action="<?php echo JRoute::_('index.php?option=com_beseated&view=chauffeur&layout=edit&chauffeur_id=' . (int) $this->item->chauffeur_id); ?>"
    method="post" name="adminForm" id="adminForm">
    <div class="form-horizontal">
        <fieldset>
            <div class="span12">
                <legend><?php echo JText::_('COM_BESEATED_CHAUFFEUR'); ?></legend
                ...
                <div class="control-group">
                    <div class="control-label"><?php echo $this->form->getLabel('chauffeur_name'); ?></div>
                    <div class="controls"><?php echo $this->form->getInput('chauffeur_name'); ?></div>
                </div>
                <div class="control-group">
