...
<script type="text/javascript">
    ...
    function addTicket_ajax()
    {
        ...
        /*for (i=0; i< jQuery('.filedata').length; i++)
        {
            console.log(jQuery(this));

            var test = jQuery(jQuery('.filedata')[i]).prop('files')[0];
            
            ticket_type_image_data.append("file_image[]", test);
        }*/
        ...
        jQuery('.filedata').each(function(index)
        {
            ...
            var test = jQuery(jQuery('.filedata')[index]).prop('files')[0];
            
            ticket_type_image_data.append('file_image['+value+']', test);
        });
    ...
    jQuery(document).ready(function()
    {
        jQuery("#addTicketTypeZone").click(function()
        {
            ...
            var html =  '<div id="container' + rand + '"><input type="button" name="container' + rand + '" id="rgm" class="btn btn-danger" style="float:right;margin-right:562px;" value="Remove">';
                ...
                html += '<input class="filedata" type="file"  name="filedata[]" />';
...
<button id="test" style="float:right; margin-bottom:15px;" >
    Add Tickets
</button>

<button id="addTicketImages" data-toggle="modal" href="#myModal" style="float:right; margin-bottom:15px;display:none;" onclick="addTicket_ajax();">
</button>
            ...
            <div class="item_lef">
                   <div id="main">
                        <?php if(empty($this->ticketsTypeZone)): ?>
                          <div id="container">
                             <input type="button" id="rmv" class="btn btn-danger" style="float:right;margin-right:460px;" value="Remove">
                                  <div class="control-group">
                                     <div class="controls1">
                                         ...
                                         <input class="filedata" type="file" id="upload_file" name="filedata[]"/>
                               ...
                               <div id="container<?php echo $ticket->ticket_type_zone_id; ?>">
                                    ...
                                    <div class="control-group">
                                     <div class="controls1">
                                         ...
                                         <input class="filedata" type="file" id="<?php echo $ticket->ticket_type_zone_id; ?>" value="<?php echo $ticket->ticket_type; ?>" name="filedata[]" />
                        ...
                        <fieldset id="upload-noflash" class="actions">
                            <div class="control-group">
                                <div class="control-label">
                                    ...
                                    <select name="uploadTickets">
                                        <?php foreach ($this->ticketsTypeZone as $key => $ticket) : ?>
                                            <?php if($ticket->ticket_type && $ticket->ticket_zone && $ticket->ticket_price): ?>
                                                <option><?php echo $ticket->ticket_type.'-'.$ticket->ticket_zone.'-'.$ticket->ticket_price; ?></option>
                                            <?php elseif($ticket->ticket_type && $ticket->ticket_price): ?>
                                                <option><?php echo $ticket->ticket_type.'-'.$ticket->ticket_price; ?></option>
                                            <?php elseif($ticket->ticket_zone && $ticket->ticket_price): ?>
                                                <option><?php echo $ticket->ticket_zone.'-'.$ticket->ticket_price; ?></option>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
