 ...
 * @since  0.0.1
 */
class BeseatedModelProtectionBookingRequest extends JModelAdmin
{
	/**
	...
	public function getForm($data = array(), $loadData = true)
	{
		// Get the form.
		$form = $this->loadForm(
			'com_beseated.protectionbookingrequest',
			'protectionbookingrequest',
			array(
				'control' => 'jform',
				'load_data' => $loadData
			)
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState(
			'com_beseated.edit.ProtectionBookingRequest.data',
			array()
		);
