 ...
 * @since  0.0.1
 */
class BeseatedModelYachtBookingRequests extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	public function getAllRequests()
	{
		...
		$query->select('a.yacht_booking_id,a.yacht_status,a.request_date_time,a.response_date_time,a.booking_date')
