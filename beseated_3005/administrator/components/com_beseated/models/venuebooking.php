 ...
 * @since  0.0.1
 */
class BeseatedModelVenueBooking extends JModelAdmin
{
	/**
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState(
			'com_beseated.edit.VenueBooking.data',
			array()
		);
	...
	public function save($data)
	{
		...
		$data['privacy']               = '0';
		$data['has_booked']            = '1';
		$data['is_bill_posted']        = '1';
		$data['total_price']           = $data['bill_post_amount'];
		$data['final_price']           = $data['bill_post_amount'];
		$data['remaining_amount']      = $data['bill_post_amount'];
		$data['hasCMSBooking']         = '1';
		...
		$target           = $user_id;
		$notificationType = "venue.booking.paidByAdmin";
		$title            = JText::sprintf(
								'COM_IJOOMERADV_BESEATED_PAID_BY_ADMIN_FOR_VENUE',
								$serviceDetail->table_name,
