...
class TableOrder extends JTable
{
    ...
    /** @var TableOrder Caches the row data on load for future reference */
    ...
    protected function onAfterStore()
    {
        ...
        // trigger email if the order got paid
        if ($this->_selfCache->paymentstatusid != $this->paymentstatusid && $this->paymentstatusid==EventgalleryLibraryOrderstatus::TYPE_PAYMENT_PAYED) {
            ...
            return $emailtemplateMgr->sendMail('paid_order', $language->getTag(), true, $data, $to, true);
        }
