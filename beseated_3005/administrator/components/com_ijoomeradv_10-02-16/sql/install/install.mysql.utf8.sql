...
(6, 'COM_IJOOMERADV_PUSH_ENABLE_SOUND', 'COM_IJOOMERADV_PUSH_ENABLE_SOUND_EXPLAIN', 'IJOOMER_PUSH_ENABLE_SOUND_IPHONE', '0', '0::No;;1::Yes', 'select', 'push>>iphone', 1),
(7, 'COM_IJOOMERADV_PUSH_DEPLOYMENT_MODE', 'COM_IJOOMERADV_PUSH_DEPLOYMENT_MODE_EXPLAIN', 'IJOOMER_PUSH_DEPLOYMENT_IPHONE', '0', '0::Sandbox;;1::Live', 'select', 'push>>iphone', 1),
