...
<form action="<?php echo JRoute::_('index.php?option=com_visforms&view=visdatas&fid=' . JFactory::getApplication()->input->getInt( 'fid', -1 ) . '&id=' . $this->item->id );?>" method="post" name="adminForm" id="item-form" class="form-validate" enctype="multipart/form-data">
                    ...
                    <?php 
                        ...
                        {   
                            ...
                            { 
                                ...
                                ?>
                                <?php if ((!empty($file->name)) && (!empty($file->path))) { ?>
                                
                                <ul id="jform_F<?php echo $field->id; ?>-fileimg" class="thumbnails">
                                    <li class="imgOutline thumbnail height-100 width-100 center">
                                        
                                    <?php echo JText::_('COM_VISFORMS_DEL'); ?>
