					...
					<div class="span5" style="margin-left:100px;">
							...
							<div class="span10">
								...
								<div class="Icon-Image" id="imageicon">
									...
									<input type="file" value="" id="imageicon1" name="imageicon" class="" aria-invalid="false" >

										<?php

										$AgetHeaders = @get_headers($dirpath.$home);
								...
								<div class="Tab-Image" id="imagetab">
									...
									<input type="file" value="" id="jform_image_tab" name="imagetab" class aria-invalid="false" >

										<?php

										$AgetHeaders = @get_headers($dirpath.$tab_img);
								...
								<div class = "Tab-Active-Image" id="imagetabactive">
									...
									<input type="file" value="" id="jform_image_tab_active" name="imagetabactive" class="" aria-invalid="false" >

										<?php

										$AgetHeaders = @get_headers($dirpath.$active_tab_img);
