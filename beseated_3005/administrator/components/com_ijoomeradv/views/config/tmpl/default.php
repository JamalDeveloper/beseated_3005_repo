...
<script type="text/javascript">
	...
	jQuery(document).ready(function()
	{
		var selectedValue = jQuery("#IJOOMER_GC_CREATE_DEBUG").val();

		if (selectedValue == '0')
		{
			jQuery("#IJOOMER_GC_SEND_EMAIL").attr("disabled", "disabled");
		};

		if (selectedValue == '1')
		{
				jQuery("#IJOOMER_GC_SEND_EMAIL").removeAttr("disabled");
		};

		jQuery("#IJOOMER_GC_CREATE_DEBUG").change(function(event)
		{
			...
			{
				jQuery("#IJOOMER_GC_SEND_EMAIL").removeAttr("disabled");
				var Value = jQuery("#IJOOMER_GC_SEND_EMAIL").val();
			};
