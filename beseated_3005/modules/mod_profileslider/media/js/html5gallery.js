        ...
        e.prototype = {
            ...
            loadCarousel: function() {
                ...
                for (var c = 0; c < this.elemArray.length; c++) {
                    var e = b("<div id='html5gallery-tn-" + this.id + "-" + c + "' class='html5gallery-tn-" + this.id + " image-thumb' data-index=" + c + " ></div>");
                    e.appendTo(d);
                    ...
                    b(e).load(function() {
                        ...
                        a.options.carouselmultirows && "samecolumn" == a.options.thumbresponsive ? b("#html5gallery-tn-" + a.id + "-" + this.data, d).append("<div class='html5gallery-tn-img-" + a.id + "' style='position:relative;width:" + String(a.options.thumbimagewidth + 2 * a.options.thumbimageborder) + "px;height:" + String(a.options.thumbimageheight + 2 * a.options.thumbimageborder) + "px;'><div style='display:block; overflow:hidden; position:absolute; width:" + a.options.thumbimagewidth +
                            ...
                            e + "px; height:" + c + "px;' src='" + a.elemArray[this.data][1] + "' /></div>" + l + "</div>");
            ...
            slideRun: function(a, d, c, e) {
                ...
                if (!(0 > a)) {
                    ...
                    this.options.playvideoonclick = true;
                    this.options.playvideoonclick = false;
            ...
            showSWF: function() {
                ...
                b(".html5gallery-elem-" + this.id, a).html("<div class='html5gallery-elem-flash-" + this.id + "' style='display:block;position:absolute;overflow:hidden;top:" + e + "px;left:" + f + "px;width:" + d + "px;height:" + c + "px;'></div>" + this.options.watermarkcode);
            ...
            showEmbedVideo: function(a) {
                ...
                b(".html5gallery-elem-" + this.id, d).html("<div class='html5gallery-loading-center-" + this.id + "'></div><div id='html5gallery-elem-video-" + this.id + "' style='display:block;position:absolute;overflow:hidden;top:" + (this.options.slideshadow &&
                    !this.isFullscreen ? 4 : 0) + "px;left:" + (this.options.slideshadow && !this.isFullscreen ? 4 : 0) + "px;width:" + e + "px;height:" + c + "px;'></div>" + this.options.watermarkcode);
            ...
            showIframe: function() {
                ...
                b(".html5gallery-elem-" + this.id, a).html("<div class='html5gallery-loading-center-" +
                    this.id + "'></div><div class='html5gallery-elem-iframe-" + this.id + "' style='display:block;position:absolute;overflow:hidden;top:" + (this.options.slideshadow && !this.isFullscreen ? 4 : 0) + "px;left:" + (this.options.slideshadow && !this.isFullscreen ? 4 : 0) + "px;width:" + c + "px;height:" + d + "px;'></div>" + this.options.watermarkcode);
