...
class plgBctPaypal extends JPlugin
{
	...
	function onPackageInvitePaymentPaypal()
	{
		...
		*/
		...
		if($bcDollars)
		{
			if($goForPaypal == 1)
			{
				$this->addLoyaltyPoints($user->id,'payout.'.$bookingType,$minusBCD,$paymentEntryID);
			...
			{
				$this->addLoyaltyPoints($user->id,'payout.'.$bookingType,$minusBCD,$paymentEntryID,1);
			}
 ...
 "
	...
	function onPreparePaymentPaypal()
	{
		...
		/*echo $bcDollars;
		exit;*/
		$pointUsed = $jinput->get('bc_dollars', 0, 'int');
		$fullPay  = 0;
		$goForPaypal = 1;
		$fullPay = 0;
		...
		if($bookingType == 'package' || $bookingType == 'Package')
		{
			...
			$coreElementPrice      = $elemntAmount;
			$coreElementCurrency   = $tblPackage->currency_code;
		...
		else if($bookingType == 'venue' || $bookingType == 'Venue')
		{
			...
			$coreElementPrice    = $tblTable->venue_table_price;
			$coreElementCurrency = $tblVenue->currency_code;
			$coreCommissionRate      = $tblVenue->commission_rate;
		}
		else if($bookingType == 'service' || $bookingType == 'Service')
		{
			...
			$coreElementPrice      = $tblServiceBooking->total_price;
			$coreElementCurrency   = $tblCompany->currency_code;
			$coreCommissionRate    = $tblCompany->commission_rate;
		}
		...
		/*echo "<br />elemnt Amount : " . $elemntAmount;
		echo "<br />depositPer : " . $depositPer;
		echo "<br />Deposit Amount : " . $depositAmount;
		echo "<br />bookingType : " . $bookingType;
		// 100
		exit;*/
		...
		else
		{
			...
			/*echo "convertedElementAmount : ".$convertedElementAmount. "<br />";
			echo "loyaltyPoints : ".$loyaltyPoints. "<br />";
			exit;*/
		}
		/*echo "elemntAmountForPoints : ".$elemntAmountForPoints." <br />";
		echo "currencyRateUSD : ".$currencyRateUSD . "<br />";
		echo "loyaltyPoints : " . $loyaltyPoints. "<br />";
		exit;*/
		...
		if($bcDollars)
		{
			...
			/*echo "BC Dollars : " . $bcdToUsd . "<br />"; // 8.0685
			echo "Currency Rate : " . $currencyRate . "<br />"; // 0.8965
			exit;*/
		...
		/*echo "Pay After BCD : " . $payAfterBCD .  "<br />";
		echo "BC Dollars : " . $bcdToUsd . "<br />"; // 8.0685
		echo "Currency Rate : " . $currencyRate . "<br />"; // 0.8965
		echo "<br />loyaltyPoints : " . $loyaltyPoints;
		echo "<br />minusBCD : " . $minusBCD;*/
		/*exit;*/
		...
		/*echo "<br /> minusBCD : " . $minusBCD;
		echo "<br /> payAfterBCD : " . $payAfterBCD;
		echo "<br /> depositAmountAfertBCD : " . $depositAmountAfertBCD;
		echo "<br /> loyaltyPer : " . $loyaltyPer;
		echo "<br /> elemntAmount : " . $elemntAmount;*/
		/*echo "<br /> minusBCD : " . $minusBCD;
		echo "<br /> minusBCD : " . $minusBCD;
		echo "<br /> minusBCD : " . $minusBCD;
		echo "<br /> minusBCD : " . $minusBCD;
		...
		if($pointUsed)
		{
			if($goForPaypal == 1)
			{
				...
				if($bookingType == 'service' || $bookingType == 'Service' || $bookingType == 'venue' || $bookingType == 'Venue')
				{
					$bcDollars = $pointUsed / 10;
					$currencyRateUSD = $this->convertCurrencyGoogle(1,$coreElementCurrency,'USD');
					$convertedCoreElementPrice = $coreElementPrice * $currencyRateUSD;

					$defaultDepositPer = ($bctParams->deposit_per)?$bctParams->deposit_per:20;
					$coreDepositPer = ($coreCommissionRate)?$coreCommissionRate:$defaultDepositPer;
					$loyaltyPer = ($bctParams->loyalty_per)?$bctParams->loyalty_per:1;

					$coreDepositAmt = (($convertedCoreElementPrice * $coreDepositPer) / 100);
					$lpAmt = $coreDepositAmt - $bcDollars;
					$bcDollarPurchasPoints = (($lpAmt * $loyaltyPer)/100);

					/*echo "<br /> currencyRateUSD : " . $currencyRateUSD;
					echo "<br /> coreElementPrice : " . $coreElementPrice;
					echo "<br /> coreElementCurrency : " . $coreElementCurrency;
					echo "<br /> coreCommissionRate : " . $coreCommissionRate;
					echo "<br /> convertedCoreElementPrice : " . $convertedCoreElementPrice;
					echo "<br /> coreDepositPer : " . $coreDepositPer;
					echo "<br /> loyaltyPer : " . $loyaltyPer;
					echo "<br /> coreDepositAmt : " . $coreDepositAmt;
					echo "<br /> lpAmt : " . $lpAmt;
					echo "<br /> bcDollarPurchasPoints : " . $bcDollarPurchasPoints;
					exit;*/

					$this->addLoyaltyPoints($user->id,'purchase.'.$bookingType,$bcDollarPurchasPoints * 10 ,$paymentEntryID);
				...
				else
				{
					...
					$loyaltyPoints = ($payAfterBCD * $loyaltyPer) / 100;
					$lpAmount      = $elemntAmount - $depositAmountAfertBCD;
					//$lpAmount = $depositAmountAfertBCD*$currencyRateUSD;
					$loyaltyPoints = ($depositAmountAfertBCD * $loyaltyPer) / 100;

					/*echo "depositAmountAfertBCD : " . $depositAmountAfertBCD .  "<br />";
					echo "lpAmount : " . $lpAmount .  "<br />";
					echo "elemntAmount : " . $elemntAmount .  "<br />";
					echo "purchase Type : " . $bookingType .  "<br />";
					echo "loyaltyPoints : " . $loyaltyPoints . "<br />"; // 8.0685
					echo "paymentEntryID : " . $paymentEntryID . "<br />"; // 0.8965
					echo "<br />loyaltyPoints : " . $loyaltyPoints;
					echo "<br />minusBCD : " . $minusBCD;
					echo "<br />Currency Rate : " . $currencyRateUSD;
					exit;*/
