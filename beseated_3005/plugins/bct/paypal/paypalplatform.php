<?php
	...
	********************************************/
	...
	//------------------------------------
	/*$API_UserName = "heena_1337399838_biz_api1.tasolglobal.com";
	$API_Password = "1337399864";
	$API_Signature = "AH6Ri6cEf-UAYCXV1NqBodv.2FHLAvzAQuGGY5UzoiEGjybd.gIkXzeS";*/

	/*$API_UserName = "nilesh-facilitator_api1.tasolglobal.com";
	$API_Password = "1395638840";
	$API_Signature = "AEEX7EYb1IX8EHcRGHCU.SATUW0EAWXH.5oqJAgAcUU0qV7ZMDZXymVz";*/

	/*$API_UserName = "rushita-facilitator_api1.tasolglobal.com";
	$API_Password = "1405763274";
	$API_Signature = "AbsCUrwii7w0XKdv6XYPV7L6nKZ5Ap1daqxtd9PI1szZ7vniZ21Ob1Lj";*/

	/*$API_UserName = "jack.hill.CC_api1.gmail.com";
	$API_Password = "HGH6KL6SCT7733AU";
	$API_Signature = "AFSlECatsh2UqN2UIUhOOtT1bG41APFFL-5bg1WbmMVfJoheWaOdMMfe";*/

	// For client Send box
	/*$API_UserName = "jack.hill.CC-facilitator_api1.gmail.com";
	$API_Password = "1409134976";
	$API_Signature = "A9fL.jJl63NMy2DEc14dfua.rs1JATC3BjbGpGe4ZgLCwwzCSNsoC1dl";
	...
	//$API_AppID = "APP-33212262SU8843257";
	...
	*/
	function CallPreapproval( $returnUrl, $cancelUrl, $currencyCode, $startingDate, $endingDate, $maxTotalAmountOfAllPayments,
								...
								$ipnNotificationUrl , $maxAmountPerPayment, $maxNumberOfPaymentsPerPeriod, $pinType )
	{
