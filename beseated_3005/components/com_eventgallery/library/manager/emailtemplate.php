...
class EventgalleryLibraryManagerEmailtemplate extends  EventgalleryLibraryManagerManager
{
    ...
    */
    ...
    public function populate($text, $data) {
        ...
        require_once JPATH_ROOT.'/components/com_eventgallery/helpers/vendors/smarty/libs/Smarty.class.php';

        $smarty = new Smarty();

        $smarty->debugging = false;
        $smarty->caching = false;
        $smarty->setCacheDir(JPATH_ROOT.DS.'cache/com_eventgallery_template_cache');
        $smarty->setCompileDir(JPATH_ROOT.DS.'cache/com_eventgallery_template_compile');
