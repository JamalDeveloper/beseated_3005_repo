...
class UsersControllerUser extends UsersController
{
	...
	public function login()
	{
		...
		if (true === $app->login($credentials, $options))
		{
			...
			if($userType == 'Club')
			{
				$app->redirect(JRoute::_('index.php?option=com_bcted&view=clubsummary&Itemid=125', false));
			}
			else if($userType == "ServiceProvider")
			{
				$app->redirect(JRoute::_('index.php?option=com_bcted&view=companysummary&Itemid=140', false));
			}
			else
			{
				$menu = $app->getMenu();
