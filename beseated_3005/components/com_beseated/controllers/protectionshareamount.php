 ...
 * @since  0.0.1
 */
class BeseatedControllerProtectionshareamount extends JControllerAdmin
{
	/**
	 * Constructor.
	 *
	...
	public function shareGuestCountUpdate()
	{
		...
		$tblProtectionBooking->total_split_count = $sharedPeopleCount;
		$tblProtectionBooking->each_person_pay   = $eachPersonPayAmount;
		...
		{
			$link = "index.php?option=com_beseated&view=protectionrequestpay&firstTimeShare=1&protection_booking_id=".$bookingID."&Itemid=".$Itemid;
			$app->redirect($link);
		}
