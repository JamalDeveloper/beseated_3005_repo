 ...
 * @since  0.0.1
 */
class BeseatedControllerChauffeurshareinvitation extends JControllerAdmin
{
	/**
	 * Constructor.
	 *
	 ...
	 * @since   0.0.1
	 */
	public function getModel($name = 'ChauffeurShareInvitation', $prefix = 'BeseatedModel', $config = array('ignore_request' => true))
	{
	...
	public function inviteUser()
	{
		...
		if($inviteType == 'email')
		{
			...
			{ 
				...
				{
				    $link = JURI::root().'index.php?option=com_beseated&view=chauffeurshareinvitation&booking_id='.$bookingID.'&Itemid='.$Itemid;
		...
		$alreadySplited       = BeseatedHelper::getSplitedDetail($bookingID,'Chauffeur');
	...
	function replaceShareInvitee()
	{
		...
		if($inviteType == 'email')
		{
			...
			{ 
				...
				{
				    $link = JURI::root().'index.php?option=com_beseated&view=chauffeurshareinvitation&invitation_id='.$invitationID.'&booking_id='.$bookingID.'&Itemid='.$Itemid;
		 	        $app->redirect($link, 'Invalid email you have entered');
					return false;
				}
			}
