 ...
 * @since  0.0.1
 */
class BeseatedControllerYachtshareamount extends JControllerAdmin
{
	/**
	 * Constructor.
	 *
	...
	public function shareGuestCountUpdate()
	{
		...
		$tblYachtBooking->total_split_count = $sharedPeopleCount;
		$tblYachtBooking->each_person_pay   = $eachPersonPayAmount;
		...
		{
			$link = "index.php?option=com_beseated&view=yachtrequestpay&firstTimeShare=1&yacht_booking_id=".$bookingID."&Itemid=".$Itemid;
			$app->redirect($link);
		}
