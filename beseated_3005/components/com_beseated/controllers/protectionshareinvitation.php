 ...
 * @since  0.0.1
 */
class BeseatedControllerProtectionshareinvitation extends JControllerAdmin
{
	/**
	 * Constructor.
	 *
	 ...
	 * @since   0.0.1
	 */
	public function getModel($name = 'ProtectionShareInvitation', $prefix = 'BeseatedModel', $config = array('ignore_request' => true))
	{
	...
	public function inviteUser()
	{
		...
		if($inviteType == 'email')
		{
			...
			{ 
				...
				{
				    $link = JURI::root().'index.php?option=com_beseated&view=protectionshareinvitation&booking_id='.$bookingID.'&Itemid='.$Itemid;
		...
		$alreadySplited       = BeseatedHelper::getSplitedDetail($bookingID,'Protection');
	...
	function replaceShareInvitee()
	{
		...
		if($inviteType == 'email')
		{
			...
			{ 
				...
				{
				    $link = JURI::root().'index.php?option=com_beseated&view=protectionshareinvitation&invitation_id='.$invitationID.'&booking_id='.$bookingID.'&Itemid='.$Itemid;
		 	        $app->redirect($link, 'Invalid email you have entered');
					return false;
				}
			}
