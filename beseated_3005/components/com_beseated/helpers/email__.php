...
class BeseatedEmailHelper
{
			            	...
			            	<table width="630" border="0" cellpadding="0" cellspacing="0">
			                	<tr>
			                        <td align="right" colspan="2">
			                        	<table width="100%" border="0" cellpadding="0" cellspacing="0">
			                            	<tr>
			                                	<td align="left" width="90"><a href="#"><img src="'.JUri::base().'images/edms/images/beseated-logo.png" width="79" height="79"></a></td>
			                    ...
			                    <tr>
			                        <td colspan="2" style="color:#000;">
			                        	<p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Dear '.$username.',<br><br><br>
			                            Thank you for your feedback, one of our agents will contact you shortly.</p><br>
			                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">This is an automated message; please do not reply to this email.</p><br>
			                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">For further assistance, kindly contact us at <a href="#" style="color:#b18839; font-family:Arial, Helvetica, sans-serif; margin:0; text-decoration:none;">contact@thebeseated.com</a></p><br>
			                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Beseated Support.</p>
			                        </td>
			                    ...
			                    <tr>
			                    	<td colspan="2" align="center" style="color:#5f5f5f;">
			                        	<a href="#" style="text-decoration:none; color:#c09439; font-family:Arial, Helvetica, sans-serif; font-size:14px;">My Beseated ID</a>&nbsp;|&nbsp;<a style="text-decoration:none;font-size:14px; color:#c09439; font-family:Arial, Helvetica, sans-serif;" href="#">Support</a>&nbsp;|&nbsp;<a style="text-decoration:none; color:#c09439; font-family:Arial, Helvetica, sans-serif;" href="#">Privacy Policy</a>
			                        </td>
			                    </tr>
			                    <tr>
			                    	<td colspan="2" align="center" style="font-family:Arial, Helvetica, sans-serif;color:#000; font-size:14px;">Copyright © 2015 Beseatedapp.com. All rights reserved.</td>
			                    </tr>
			                    <tr>
			                    	<td colspan="2" align="center" style="font-family:Arial, Helvetica, sans-serif;color:#000; font-size:14px;">This email was sent by Beseatedapp.com, THUB, Dubai Silicon Oasis, Dubai, United Arab Emirates</td>
			                    </tr>
			                </table>
			            </td>
			        </tr>
	...
	public function jetBookingThankYouEmail($privateJetID,$personName,$email,$phone,$flight_date,$fromLocation,$toLocation,$totalGuest,$extraInformation)
	{
						        ...
						        <tr>
						        	<td align="center">
						            	<table width="630" border="0" cellpadding="0" cellspacing="0">
						                    ...
						                    <tr>
						                        <td colspan="2" style="color:#000;">
						                        	<p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Dear Admin,<br><br><br>
						                    ...
						                    <tr>
						                    	<td colspan="2">
						                        	<p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Kindly contact '.$personName.' on our behalf and proceed with your usual procedures.</p><br>
						                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;"> Keep us updated on this booking, so that we can reward '.$personName.' with coins.</p><br>
						                        </td>
						                    </tr>
						                     <tr>
						                    ...
						                    <tr>
						                    	<td colspan="2"><p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Beseated Support.</p></td>
						                    </tr>
						                    <tr>
						                    	<td colspan="2" height="30">
						                        </td>
					        ...
					        <tr>
					        	<td align="center">
					            	<table width="630" border="0" cellpadding="0" cellspacing="0">
					                    ...
					                    <tr>
					                        <td colspan="2" style="color:#000;">
					                        	<p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Dear '.$userDetail->name.',<br><br><br>
					                            The password for your '.$userDetail->email.' has been successfully reset.</p><br>
					                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Your new password:'.$newPassword.'</p><br>
					                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Please login using this password, then go to your profile, and set a new password.</p><br>
					                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">If you believe you have received this email in error, or that an unauthorized person has accessed your account, please <a href="'.$loginLink.'">click Here </a>to reset your password immediately.</p><br>
					                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Questions?There are lots of answers on our <a href="#" style="text-decoration:none; color:#b18839;">FAQ</a>&rsquo;s, your question might be already answered.</p><br>
					                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">If you are still having problem, please contact us at <a href="#" style="text-decoration:none; color:#b18839;">contact@beseatedapp.com</a></p><br>
					                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Beseated Support.</p>
					                        </td>
					                    </tr>
					                    <tr>
					                    ...
					                    <tr>
					                    	<td colspan="2" align="center" style="color:#5f5f5f;">
					                        	<a href="#" style="text-decoration:none; color:#c09439; font-family:Arial, Helvetica, sans-serif; font-size:14px;">My Beseated ID</a>&nbsp;|&nbsp;<a style="text-decoration:none; color:#c09439; font-family:Arial, Helvetica, sans-serif; font-size:14px;" href="#">Support</a>&nbsp;|&nbsp;<a style="text-decoration:none; color:#c09439; font-family:Arial, Helvetica, sans-serif;" href="#">Privacy Policy</a>
					                        </td>
					                    </tr>
					                    <tr>
					                    	<td colspan="2" align="center" style="font-family:Arial, Helvetica, sans-serif;color:#000; font-size:14px;">Copyright © 2015 Beseatedapp.com. All rights reserved.</td>
					            	...
					            	<table width="630" border="0" cellpadding="0" cellspacing="0">
					                    ...
					                    <tr>
					                        <td colspan="2" style="color:#000;">
					                            ...
					                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">If you do not recognize this action and that an unauthorized person has accessed your account,<br>please click <a href="'.$loginLink.'" style="color:#b58b39; text-decoration:none;">here</a> to reset your password immediately.</p><br>
					                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Beseated Support.</p>
					                        </td>
					                    </tr>
					                    <tr>
					                    ...
					                    <tr>
					                    	<td colspan="2" align="center" style="color:#5f5f5f;">
					                        	<a href="#" style="text-decoration:none; color:#c09439; font-family:Arial, Helvetica, sans-serif; font-size:14px;">My Beseated ID</a>&nbsp;|&nbsp;<a style="text-decoration:none; color:#c09439; font-size:14px; font-family:Arial, Helvetica, sans-serif;" href="#">Support</a>&nbsp;|&nbsp;<a style="text-decoration:none; color:#c09439; font-family:Arial, Helvetica, sans-serif;" href="#">Privacy Policy</a>
					                        </td>
					                    </tr>
					                    <tr>
					                    	<td colspan="2" align="center" style="font-family:Arial, Helvetica, sans-serif;color:#000; font-size:14px;">Copyright © 2015 Beseatedapp.com. All rights reserved.</td>
					            	...
					            	<table width="630" border="0" cellpadding="0" cellspacing="0">
					                    ...
					                    <tr>
					                        <td colspan="2" style="color:#000;">
					                        	...
					                        	<p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Dear '.$userName.',<br><br>
					                            Welcome to Beseated, Luxury booking for the Elite.</p><br>
					                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;"><a href="'.$activationLink.'" style="color:#b18839; font-family:Arial, Helvetica, sans-serif; margin:0; text-decoration:none;">Activate Now</a></p><br>

					                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Why you received this email?</p><br>

					                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Beseated requests verification whenever an Elite joins Beseated.</p><br>
					                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Your Beseated account cannot be used until you verify it.</p><br><br>
					            	...
					            	<table width="630" border="0" cellpadding="0" cellspacing="0">
					                    ...
					                    <tr>
					                        <td colspan="2" style="color:#000;">
					                            ...
					                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">We are constantly changing the rewards, so make sure you always check our new rewards.</p><br>
					                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Hope to see you soon again.</p><br>
					                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Beseated Support.</p>
					                        </td>
					                    </tr>
					                    <tr>
					                    ...
					                    <tr>
					                    	<td colspan="2" align="center" style="color:#5f5f5f; font-size:14px;">
					                        	<a href="#" style="text-decoration:none; color:#c09439;font-size:14px; font-family:Arial, Helvetica, sans-serif;">My Beseated ID</a>&nbsp;|&nbsp;<a style="text-decoration:none; color:#c09439;font-size:14px; font-family:Arial, Helvetica, sans-serif;" href="#">Support</a>&nbsp;|&nbsp;<a style="text-decoration:none; color:#c09439; font-family:Arial, Helvetica, sans-serif; font-size:14px;" href="#">Privacy Policy</a>
					                        </td>
					                    </tr>
					                    <tr>
					                    	<td colspan="2" align="center" style="font-family:Arial, Helvetica, sans-serif;color:#000; font-size:14px;">Copyright © 2015 Beseatedapp.com. All rights reserved.</td>
									        ...
									        <tr>
									        	<td align="center">
									            	<table width="630" border="0" cellpadding="0" cellspacing="0">
									                    ...
									                    <tr>
									                        <td colspan="2" style="color:#000;">
									                        	<p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Dear '.$refByUserName.',<br><br><br>
									                            CONGRATULATIONS</p><br>
									                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">You have earned &nbsp;<img src="'.JUri::base().'images/edms/images/money-icn.png" width="21" height="21" style="vertical-align:middle;">&nbsp; '.$points.' for referring '.$referedUser.'.</p><br>
									                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Don’t we all love to Be Treated! </p><br>
									                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Beseated Support.</p>
									                        </td>
									                    ...
									                    <tr>
									                    	<td colspan="2" align="center" style="color:#5f5f5f; font-size:14px;">
									                        	<a href="#" style="text-decoration:none; color:#c09439; font-size:14px; font-family:Arial, Helvetica, sans-serif;">My Beseated ID</a>&nbsp;|&nbsp;<a style="text-decoration:none; color:#c09439; font-size:14px; font-family:Arial, Helvetica, sans-serif;" href="#">Support</a>&nbsp;|&nbsp;<a style="text-decoration:none; font-size:14px; color:#c09439; font-family:Arial, Helvetica, sans-serif;" href="#">Privacy Policy</a>
									                        </td>
									                    </tr>
									                    <tr>
									                    	<td colspan="2" align="center" style="font-family:Arial, Helvetica, sans-serif;color:#000; font-size:14px;">Copyright © 2015 Beseatedapp.com. All rights reserved.</td>
							        ...
							        <tr>
							        	<td align="center">
							            	<table width="630" border="0" cellpadding="0" cellspacing="0">
							                    ...
							                    <tr>
							                        <td colspan="2" style="color:#000;">
							                        	<p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Dear '.$email.',<br><br><br>
							                            '.$inviteename.' has invited you to join Beseated.</p><br>
							                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Beseated, Luxury Bookings for the Elite.</p><br>
							                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Click <a href="'.$link.'" style="color:#b18839; font-family:Arial, Helvetica, sans-serif; margin:0; text-decoration:none;">here</a> to sign up</p><br>
							                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Beseated Support.</p>
							                        </td>
								            	...
								            	<table width="630" border="0" cellpadding="0" cellspacing="0">
								                    ...
								                    <tr>
								                        <td colspan="2" style="color:#000;">
								                            ...
								                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Your voice is always heard.</p><br>
								                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">We will forward your review to the concerned party.</p><br>
								                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Beseated Support.</p>
								                        </td>
								                    </tr>
								                    <tr>
								                    ...
								                    <tr>
								                    	<td colspan="2" align="center" style="color:#5f5f5f; font-size:14px;">
								                        	<a href="#" style="text-decoration:none; color:#c09439; font-family:Arial, Helvetica, sans-serif; font-size:14px;">My Beseated ID</a>&nbsp;|&nbsp;<a style="text-decoration:none; color:#c09439; font-family:Arial, Helvetica, sans-serif; font-size:14px;" href="#">Support</a>&nbsp;|&nbsp;<a style="text-decoration:none; color:#c09439; font-size:14px; font-family:Arial, Helvetica, sans-serif;" href="#">Privacy Policy</a>
								                        </td>
								                    </tr>
								                    <tr>
								                    	<td colspan="2" align="center" style="font-family:Arial, Helvetica, sans-serif;color:#000;font-size:14px;">Copyright © 2015 Beseatedapp.com. All rights reserved.</td>
							        ...
							        <tr>
							        	<td align="center">
							            	<table width="630" border="0" cellpadding="0" cellspacing="0">
							                    ...
							                    <tr>
							                        <td colspan="2" style="color:#000;">
							                        	<p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Dear '.$company_name.',<br><br><br>
							                            '.$userName.' has rated your '.$company_name.'!
							</p><br>
							                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">You can view this rating within your Beseated Ratings Page on your account.
							</p><br>
							                        </td>
							                    </tr>
							                    <tr>
	...
	public function userNewMessageMail($userName,$company_name,$message,$email)
	{
		$lang = JFactory::getLanguage();
		$extension = 'com_beseated';
		$base_dir = JPATH_SITE;
							        	...
							        	<td align="center">
							            	<table width="630" border="0" cellpadding="0" cellspacing="0">
							                    ...
							                    <tr>
							                        <td colspan="2" style="color:#000;">
							                        	<p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Dear '.$userName.',<br><br><br>
							                            You have received a new message from '.$company_name.'.</p><br>
							                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">“'.$message.'” </p><br>
							                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">You can also view messages within your Messages tab.</p><br>
							                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Beseated Support.</p>
							                        </td>
							                    </tr>
							                    <tr>
							                    ...
							                    <tr>
							                    	<td colspan="2" align="center" style="color:#5f5f5f; font-size:14px;">
							                        	<a href="#" style="text-decoration:none; color:#c09439; font-size:14px; font-family:Arial, Helvetica, sans-serif;">My Beseated ID</a>&nbsp;|&nbsp;<a style="text-decoration:none; font-size:14px; color:#c09439; font-family:Arial, Helvetica, sans-serif;" href="#">Support</a>&nbsp;|&nbsp;<a style="text-decoration:none; color:#c09439; font-size:14px; font-family:Arial, Helvetica, sans-serif;" href="#">Privacy Policy</a>
							                        </td>
							                    </tr>
							                    <tr>
							                    	<td colspan="2" align="center" style="font-family:Arial, Helvetica, sans-serif;color:#000; font-size:14px;">Copyright © 2015 Beseatedapp.com. All rights reserved.</td>
							            	...
							            	<table width="630" border="0" cellpadding="0" cellspacing="0">
							                    ...
							                    <tr>
							                        <td colspan="2" style="color:#000;">
							                        	<p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Dear '.$userName.',<br><br><br>
							                            CONGRATULATIONS!</p><br>
							                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">You are now listed as one of '.$company_name.'’s biggest spenders on Beseated.</p><br>
							                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Your proﬁle image can be shown on the venue info page only if the Biggest spender toggle in your proﬁle screen is switched on.
							</p><br>
							                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Beseated Support.</p>
							                        </td>
							                    </tr>
							                    ...
							                    <tr>
							                    	<td colspan="2" align="center" style="color:#5f5f5f; font-size:14px;">
							                        	<a href="#" style="text-decoration:none; color:#c09439; font-size:14px; font-family:Arial, Helvetica, sans-serif;">My Beseated ID</a>&nbsp;|&nbsp;<a style="text-decoration:none; color:#c09439; font-family:Arial, Helvetica, sans-serif; font-size:14px;" href="#">Support</a>&nbsp;|&nbsp;<a style="text-decoration:none; color:#c09439; font-family:Arial, Helvetica, sans-serif; font-size:14px;" href="#">Privacy Policy</a>
							                        </td>
							                    </tr>
							                    <tr>
							                    	<td colspan="2" align="center" style="font-family:Arial, Helvetica, sans-serif;color:#000; font-size:14px;">Copyright © 2015 Beseatedapp.com. All rights reserved.</td>
							        ...
							        <tr>
							        	<td align="center">
							            	<table width="630" border="0" cellpadding="0" cellspacing="0">
							                    ...
							                    <tr>
							                        <td colspan="2" style="color:#000;">
							                        	<p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Dear '.$invitedUserName.',<br><br><br>
							                            '.$inviteeName.' has invited you to join them at '.$venue_name.' for their '.$table_name.' on '.$booking_date.'';

						                            	if($isNightVenue == 0)
						                            	{
						                            			$emailBody .=  ' at '.$booking_time.'.</p><br>';
						                            	}

							                             $emailBody .= '
							                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">You can view this invite in your messages tab, and if you do not have an account yet, you can register at our Website or Mobile application using this email address and the booking information will be waiting for you.
							</p><br>
							                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Beseated Support.</p>
							                        </td>
							                    </tr>
							                    ...
							                    <tr>
							                    	<td colspan="2" align="center" style="color:#5f5f5f; font-size:14px;">
							                        	<a href="#" style="text-decoration:none; color:#c09439; font-family:Arial, Helvetica, sans-serif; font-size:14px;">My Beseated ID</a>&nbsp;|&nbsp;<a style="text-decoration:none; color:#c09439; font-size:14px; font-family:Arial, Helvetica, sans-serif;" href="#">Support</a>&nbsp;|&nbsp;<a style="text-decoration:none; color:#c09439; font-size:14px; font-family:Arial, Helvetica, sans-serif;" href="#">Privacy Policy</a>
							                        </td>
							                    </tr>
							                    <tr>
							                    	<td colspan="2" align="center" style="font-family:Arial, Helvetica, sans-serif;color:#000; font-size:14px;">Copyright © 2015 Beseatedapp.com. All rights reserved.</td>
							        ...
							        <tr>
							        	<td align="center">
							            	<table width="630" border="0" cellpadding="0" cellspacing="0">
							                    ...
							                    <tr>
							                        <td colspan="2" style="color:#000;">
							                        	<p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Dear '.$bookingUserName.',<br><br><br>
							                            '.$requestedUserName.' has requested to join you their '.$table_name.' at '.$venue_name.' on '.$booking_date.'';
							                            ...
							                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">You can view this request in your RSVP tab.</p><br>
							                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Beseated Support.</p>
							                        </td>
							                    </tr>
							                    <tr>
							        ...
							        <tr>
							        	<td align="center">
							            	<table width="630" border="0" cellpadding="0" cellspacing="0">
							                    ...
							                    <tr>
							                        <td colspan="2" style="color:#000;">
							                        	<p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Dear '.$attending_username.',<br><br><br>
							                            ...
							                            $emailBody.= '.</p><br><p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">You can view this booking in your Booking tab.</p><br>
							                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Beseated Support.</p>
							                        </td>
							                    </tr>
							                    <tr>
							        ...
							        <tr>
							        	<td align="center">
							            	<table width="630" border="0" cellpadding="0" cellspacing="0">
							                    ...
							                    <tr>
							                        <td colspan="2" style="color:#000;">
							                        	<p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Dear '.$booking_owner_name.',<br><br><br>
							                            I sincerely hope that you are well. Thank you for selecting Beseated as your means to connect with your favorite Venues and Premium Service Providers.</p><br>
							                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">We noticed you were unable to attend your booking made at '.$venue_name.' on '.$booking_date.'';
							            	...
							            	<table width="630" border="0" cellpadding="0" cellspacing="0">
							                    ...
							                    <tr>
							                        <td colspan="2" style="color:#000;">
							                        	<p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Dear '.$booking_owner_name.',<br><br><br>
							                            I sincerely hope that you are well. Thank you for selecting Beseated as your means to connect with your favorite Venues and Premium Service Providers.</p><br>
							                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">We noticed you were unable to attend your booking made at '.$element_name.' on '.$booking_date.' at '.$booking_time.'. Since this is your ﬁrst No Show, we will refund your payment.
							</p><br>
							<p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">As you are aware, when you book with Beseated, other people miss the opportunity to book the same luxury.  We understand that there are some occasions when the customer must miss a booking due to unforeseen circumstances beyond his or her control.  In this event, we ask that you cancel your booking on our Beseated Platforms prior to 24 hours of a booking.  If you fail to do so, the next time you are considered a No Show, we will not be able to refund your payment as per our Policies.
							        	...
							        	<td align="center">
							            	<table width="630" border="0" cellpadding="0" cellspacing="0">
							                    ...
							                    <tr>
						                            ...
						                            $emailBody .='. </p><br>
							                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Hopefully it will work out next time.</p><br>
							                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Beseated Support.</p>
							                        </td>
							                    </tr>
							                    <tr>
						            	...
						            	<table width="630" border="0" cellpadding="0" cellspacing="0">
						                    ...
						                    <tr>
						                        <td colspan="2" style="color:#000;">
						                            ...
						                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">We understand that there are some occasions when the customer must cancel a booking due to unforeseen circumstances beyond his or her control.
						</p><br>
						<p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Appreciate your understanding.</p><br>
						                        </td>
						                    </tr>
						                    <tr>
						                    	<td colspan="2" height="20">
							        	...
							        	<td align="center">
							            	<table width="630" border="0" cellpadding="0" cellspacing="0">
							                    ...
							                    <tr>
							                        <td colspan="2" style="color:#000;">
							                        	<p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Dear '.$userName.',<br><br><br>
							                            You have been successfully added to '.$venue_name.' Guestlist on '.$booking_date.'. </p><br>
							                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Beseated Support.</p>
							                        </td>
							                    </tr>
							                    <tr>
							        	...
							        	<td align="center">
							            	<table width="630" border="0" cellpadding="0" cellspacing="0">
							                    ...
							                    <tr>
							                        <td colspan="2" style="color:#000;">
							                        	<p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Dear '.$userName.',<br><br><br>
							                            Unfortunately, '.$venue_name.' guestlist on '.$booking_date.' is currently full. Please try another date or venue.</p><br>
							                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">If there is a will, there is a way. Booking a table always gives you a better chance in getting in and having a more exclusive night.
							</p><br>
							                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Beseated Support.</p>
							                        </td>
							                    </tr>
						        ...
						        <tr>
						        	<td align="center">
						            	<table width="630" border="0" cellpadding="0" cellspacing="0">
						                    ...
						                    <tr>
						                        <td colspan="2" style="color:#000;">
						                        	<p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Dear '.$venue_name.',<br><br><br>
						                            '.$userName.' has requested to be added to the guestlist on '.$booking_date.' for '.$total_guest.' people.
						</p><br>
						                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Kindly conﬁrm availability as soon as possible.
						</p><br>
						                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Beseated Support.</p>
						                        </td>
						                    </tr>
	...
	public function NoShowLuxuryManagerMail($booking_owner_name,$element_name,$email,$elementType)
	{
		//$email = "jamal@tasolglobal.com";
							        ...
							        <tr>
							        	<td align="center">
							            	<table width="630" border="0" cellpadding="0" cellspacing="0">
							                    ...
							                    <tr>
							                        <td colspan="2" style="color:#000;">
							                        	<p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Dear '.$element_name.',<br><br><br>
							                            ...
							                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">We understand that there are some occasions when the customer must miss a booking due to unforeseen circumstances beyond his or her control.
							</p><br>
							                    <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">However, we do apologize on behalf of '.$booking_owner_name.', hoping it wont happen again.
							</p><br>
							<p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Appreciate your understanding.</p><br>
							                        </td>
							                    </tr>
							        	...
							        	<td align="center">
							            	<table width="630" border="0" cellpadding="0" cellspacing="0">
							                    ...
							                    <tr>
							                        <td colspan="2" style="color:#000;">
							                        	<p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">Dear '.$element_name.',<br><br><br>
							                            '.$username.' reservation for '.$service_name.' on '.$booking_date.'';
							                            ...
							                            $emailBody.=' has been successfully made.</p><br><p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:0;">You can view this booking within your Beseated Booking Tab.
							</p><br>
							                        </td>
							                    </tr>
							                    <tr>
							        ...
							        <tr>
							        	<td align="center">
							            	<table width="630" border="0" cellpadding="0" cellspacing="0">
							                	<tr>
							                        <td align="center" colspan="2">
							                        	<table width="100%" cellpadding="0" cellspacing="0">
							                            	<tr>
							                                	<td align="left" width="100"><a href="#"><img src="'.JUri::base().'images/edms/images/beseated-logo.png" width="79" height="79"></a></td>
							                                    <td align="center"></td>
							                                </tr>
							                            </table>
							                        </td>
							                    ...
							                    <tr>
							                    	<td colspan="2"><h3 style="margin:0; line-height:normal; color:#000; font-family:Arial, Helvetica, sans-serif; font-weight:normal;">Dear '.$username.',</h3></td>
							                    </tr>
							                    <tr>
							                    	<td colspan="2" height="20"></td>
							                    </tr>
							                    <tr>
							                    	<td colspan="2">
							                        	<table width="100%" border="0" cellpadding="10" cellspacing="0" bgcolor="e3d1b0">
							                            	<tr>
							                                	<td colspan="2"><h4 style="margin:0; line-height:normal; color:#000; font-family:Arial, Helvetica, sans-serif; font-weight:normal; font-size:18px;">'.$companyName.'</h4></td>
							                                </tr>
							                                <tr>
							                                	<td width="320">
							                                ...
							                                <tr>
							                                    ...
							                                    <td style="border-bottom:1px solid #b78f40;font-family:Arial, Helvetica, sans-serif; color:#000;">'.($maleGuest+$femaleGuest).' Clients - '.$maleGuest.' Male / '.$femaleGuest.' Females</td>
							                                </tr>
							                                <tr>
							                                    <td style="font-family:Arial, Helvetica, sans-serif; color:#000;">Requested by</td>
							                                    <td style="font-family:Arial, Helvetica, sans-serif; color:#000;">'.$username.' (<a href='.$userEmail.' style="color:#000; text-decoration:none;">'.$userEmail.'</a>)</td>
							                                </tr>
							                            </table>
							                        </td>
							                    </tr>
							                    ...
							                    <tr>
							                    	<td colspan="2" style="font-size:14px; margin:0; font-family:Arial, Helvetica, sans-serif; color:#000;">
							                        	You can view your booking request status within your <a href="#" style="color:#b48b3b;">booking tab</a>.
							                        </td>
							                    </tr>
							                    <tr>
							                    	<td colspan="2" height="40">
							        ...
							        <tr>
							        	<td align="center">
							            	<table width="630" border="0" cellpadding="0" cellspacing="0">
							                    ...
							                    <tr>
							                    	<td colspan="2"><h3 style="margin:0; line-height:normal; color:#000; font-family:Arial, Helvetica, sans-serif; font-weight:normal;">Dear '.$companyName.',</h3></td>
							                    </tr>
							                    <tr>
							                    	<td colspan="2" height="20"></td>
							                    </tr>
							                   ...
							                   <tr>
							                    	<td colspan="2" style="font-size:14px; margin:0; font-family:Arial, Helvetica, sans-serif; color:#000;">
							                        	Please view your booking request within your bookings tab to conﬁrm availability.
							                        </td>
							                    </tr>
							                    <tr>
							                    	<td colspan="2" height="20">
							        ...
							        <tr>
							        	<td align="center">
							            	<table width="630" border="0" cellpadding="0" cellspacing="0">
							                    ...
							                    <tr>
							                    	<td colspan="2" style="font-size:14px; margin:0; font-family:Arial, Helvetica, sans-serif; color:#000;">
							                        	Please view your booking request within your bookings tab to conﬁrm.
							                        </td>
							                    </tr>
							                    <tr>
							                    	<td colspan="2" height="20">
							                    ...
							                    <tr>
							                    	<td colspan="2" style="font-size:14px; margin:0; font-family:Arial, Helvetica, sans-serif; color:#000;">
							                        	You can also add bottle service if desired.
							                        </td>
							                    </tr>
							                    <tr>
							                    	<td colspan="2" height="40">
							        ...
							        <tr>
							        	<td align="center">
							            	<table width="630" border="0" cellpadding="0" cellspacing="0">
			                                    ...
			                                    <tr>
			                                    	<td colspan="2" style="font-size:14px; margin:0; font-family:Arial, Helvetica, sans-serif; color:#000;">
			                                        	Please try a different time or date, or you can try booking at another one of our exclusive patners.
			                                        </td>
			                                    </tr>
			                                    <tr>
			                                    	<td colspan="2" height="40">
							        ...
							        <tr>
							        	<td align="center">
							            	<table width="630" border="0" cellpadding="0" cellspacing="0">
							                    ...
							                    <tr>
							                    	<td colspan="2" style="font-size:14px; margin:0; font-family:Arial, Helvetica, sans-serif; color:#000;">
							                        	Please view your booking request within your bookings tab to pay.
							                        </td>
							                    </tr>
							                    <tr>
							                    	<td colspan="2" height="40">
	...
	public function protectionBookingRequestUserMail($companyName,$thumb,$bookingDate,$bookingTime,$totalHours,$username,$userEmail,$currency_code,$price_per_hours,$total_price,$email)
	{
		//$email =  "jamal@tasolglobal.com";
							        ...
							        <tr>
							        	<td align="center">
							            	<table width="630" border="0" cellpadding="0" cellspacing="0">
							                    ...
							                    <tr>
							                    	<td colspan="2">
							                        	<table width="100%" border="0" cellpadding="10" cellspacing="0" bgcolor="e3d1b0">
							                                ...
							                                <tr>
							                                    <td style="border-bottom:1px solid #b78f40;font-family:Arial, Helvetica, sans-serif; color:#000;">Protection Name</td>
							                                    <td style="border-bottom:1px solid #b78f40;font-family:Arial, Helvetica, sans-serif; color:#000;">'.$companyName.'</td>
							                                </tr>
							                                <tr>
							                                    <td style="border-bottom:1px solid #b78f40;font-family:Arial, Helvetica, sans-serif; color:#000;">Hours</td>
							                                    <td style="border-bottom:1px solid #b78f40;font-family:Arial, Helvetica, sans-serif; color:#000;">'.$totalHours.'</td>
							                                </tr>
							                                <tr>
							                                    <td style="font-family:Arial, Helvetica, sans-serif; color:#000;">Booked by</td>
							                                    <td style="font-family:Arial, Helvetica, sans-serif; color:#000;">'.$username.' (<a href='.$userEmail.' style="color:#000; text-decoration:none;">'.$userEmail.'</a>)</td>
																						...
																						<td colspan="4">
																							<table width="100%" cellpadding="0" cellspacing="0">
										                                                        <tr>
										                                                            ...
										                                                            <td width="115" style="font-family:Arial, Helvetica, sans-serif; color:#000;">'.$totalHours.'</td>
							                    ...
							                    <tr>
							                    	<td style="font-size:14px; margin:0; font-family:Arial, Helvetica, sans-serif; color:#000;" colspan="2">                   	You can view your booking request status within your <a style="color:#b48b3b;" href="#">booking tab</a>.
							                        </td>
							                    </tr>
							                    <tr>
							                    	<td colspan="2" height="40">
	...
	public function protectionBookingRequestManagerMail($companyName,$thumb,$bookingDate,$bookingTime,$totalHours,$username,$userEmail,$currency_code,$price_per_hours,$total_price,$email)
	{
		//$email =  "jamal@tasolglobal.com";
	...
	public function protectionBookingNotAvailableUserMail($username,$companyName,$thumb,$bookingDate,$bookingTime,$totalHours,$userEmail,$currency_code,$price_per_hours,$total_price,$email)
	{
		//$email =  "jamal@tasolglobal.com";
							        ...
							        <tr>
							        	<td align="center">
							            	<table width="630" border="0" cellpadding="0" cellspacing="0">
							                    ...
							                    <tr>
							                    	<td colspan="2" style="font-size:14px; margin:0; font-family:Arial, Helvetica, sans-serif; color:#000;">
							                        	We are sorry, but it seems that the protection you have requested is not available.
							                        </td>
							                    </tr>
							                    <tr>
							                    	<td colspan="2" height="20">
							                    ...
							                    <tr>
							                    	<td style="font-size:14px; margin:0; font-family:Arial, Helvetica, sans-serif; color:#000;" colspan="2">                   	Please try a different time or date, or you can try booking at another one of our exclusive patners.
							                        </td>
							                    </tr>
							                    <tr>
							                    	<td colspan="2" height="40">
	...
	public function protectionBookingAvailableUserMail($username,$companyName,$thumb,$bookingDate,$bookingTime,$totalHours,$userEmail,$currency_code,$price_per_hours,$total_price,$email)
	{
		//$email =  "jamal@tasolglobal.com";
	...
	public function venueBookingconfirmedUserMail($username,$companyName,$venueThumb,$location,$userPhoneNo,$showDirection,$bookingID,$bookingDate,$bookingTime,$table_name,$currency_code,$min_price,$male_guest,$female_guest,$passkey,$username,$userEmail,$bottleRow,$totalBottlePrice,$email)
	{
		//$email =  "jamal@tasolglobal.com";
		...
		$emailBody        = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
								...
								<tbody>
							        ...
							        <tr>
							        	<td align="center">
							            	<table width="630" border="0" cellpadding="0" cellspacing="0">
							                	<tr>
							                    	<td align="left"><a href="#"><img src="'.JUri::base().'images/edms/images/beseated-logo.png" width="79" height="79"></a></td>
							                        <td align="right"><a href="#"><img src="'.JUri::base().'images/edms/images/print-btn.png" width="200" height="39"></a></td>
							                    </tr>
							                    <tr>
							                    	<td colspan="2" height="20"></td>
							                    </tr>
							                    ...
							                    <tr>
							                    	<td colspan="2">
							                        	<table width="100%" border="0" cellpadding="10" cellspacing="0" bgcolor="e3d1b0">
							                                                ...
							                                                <td>
							                                                    <table width="100%" border="0" cellpadding="10" cellspacing="0">
							                                                        <tr>
							                                                            ...
							                                                            <td>
							                                                                <table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000;">
							                                                                    <tr>
							                                                                        <td>Address:</td>
							                                                                        <td>'.$location.'</td>
							                                                                    </tr>
							                                                                    ...
							                                                                    <tr>
							                                                                        <td>Getting There:</td>
							                                                                        <td><a href="'.JUri::base().'components/com_beseated/helpers/map.php?location='.$location.'">'.$showDirection.'</a></td>
							                                                                    </tr>
							                                                                </table>
							                                                            </td>
							                                                        </tr>
							                                ...
							                                <tr>
							                                    <td style="border-bottom:1px solid #b78f40;font-family:Arial, Helvetica, sans-serif; color:#000;">Number of People</td>
							                                    <td style="border-bottom:1px solid #b78f40;font-family:Arial, Helvetica, sans-serif; color:#000;">'.($male_guest+$female_guest).' Clients - '.$male_guest.' Male / '.$female_guest.' Females</td>
							                                </tr>
							                                <tr>
							                                        	...
							                                        	<tr>
							                                                ...
							                                                <td width="98%">
																				<table width="100%" border="0" cellpadding="6" cellspacing="0">
							                                                        ...
							                                                        <tr>
							                                                        	<td colspan="3">
							                                                            	<p style="margin:0; text-decoration:underline;font-family:Arial, Helvetica, sans-serif; color:#000;">Please Note:</p>
							                                                            	<p style="margin:0px; font-family:Arial, Helvetica, sans-serif; color:#000;">- Any extra items requested at venue, are subject to addtional charges</p>
							<p style="margin:0px; font-family:Arial, Helvetica, sans-serif;color:#000;">- The total price shown is the amount you will pay at the venue. BESEATED does not charges any reservation, administration or other fees.</p>
							                                                            </td>
							                                                        </tr>
							                                                    </table>
							                                                </td>
							...
							<p style="margin:0;font-family:Arial, Helvetica, sans-serif; color:#000;">You will be awarded loyalty coins after payment is made at venue.</p>
							                    ...
							                    <tr>
							                        ...
							                        <td style="font-family:Arial, Helvetica, sans-serif; color:#000;">You have the right to cancel 24 hours prior to date of reservation. <br><br>If canceled later or in case of no show, the venue has the right to block you from future reservations at their venue.</td>
	...
	public function yachtBookingconfirmedUserMail($username,$companyName,$thumb,$yacht_booking_id,$bookingDate,$bookingTime,$companyName,$service_name,$dock,$capacity,$total_hours,$username,$userEmail,$currency_code,$price_per_hours,$total_hours,$total_price,$loyaltyPoint,$email)
	{
							                    	...
							                    	<td colspan="2">
							                        	<table width="100%" border="0" cellpadding="10" cellspacing="0" bgcolor="e3d1b0">
							                                ...
							                                <tr>
							                                 ...
							                                 <tr>
							                                    <td style="border-bottom:1px solid #b78f40;font-family:Arial, Helvetica, sans-serif; color:#000;">Hours</td>
							                                    <td style="border-bottom:1px solid #b78f40;font-family:Arial, Helvetica, sans-serif; color:#000;">'.$total_hours.'</td>
							                                </tr>
							                                <tr>
							                                    <td style="font-family:Arial, Helvetica, sans-serif; color:#000;">Booked by</td>
							                                    <td style="font-family:Arial, Helvetica, sans-serif; color:#000;">'.$username.' (<a href='.$userEmail.' style="color:#000; text-decoration:none;">'.$userEmail.'</a>)</td>
																						...
																						<td colspan="4">
																							<table width="100%" cellpadding="0" cellspacing="0">
										                                                        <tr>
										                                                        	<td width="190" style="font-family:Arial, Helvetica, sans-serif; color:#000;">'.$companyName.'</td>
										                                                            <td width="170" style="font-family:Arial, Helvetica, sans-serif; color:#000;">'.$currency_code.' '.$price_per_hours.' </td>
										                                                            <td width="115" style="font-family:Arial, Helvetica, sans-serif; color:#000;">'.$total_hours.'</td>
							                                                                        <td style="font-family:Arial, Helvetica, sans-serif; color:#000;">'.$currency_code.' '.$total_price.'</td>
										                                                        </tr>
																							</table>
																						</td>
	...
	public function protectionBookingconfirmedUserMail($username,$companyName,$thumb,$protection_booking_id,$bookingDate,$bookingTime,$companyName,$total_hours,$username,$userEmail,$currency_code,$price_per_hours,$total_price,$loyaltyPoint,$email)
	{
	...
	public function chauffeurBookingconfirmedUserMail($username,$companyName,$thumb,$chauffeur_booking_id,$bookingDate,$bookingTime,$companyName,$service_name,$pickup_location,$dropoff_location,$capacity,$username,$currency_code,$total_price,$userEmail,$loyaltyPoint,$email)
	{
							        ...
							        <tr>
							        	<td align="center">
							            	<table width="630" border="0" cellpadding="0" cellspacing="0">
							                    ...
							                    <tr>
							                    	<td width="30%" valign="top" style="font-family:Arial, Helvetica, sans-serif; color:#000;">Cancellation Policy</td>
							                        <td style="font-family:Arial, Helvetica, sans-serif; color:#000;">You have the right to cancel 24 hours prior to date of pickup. <br><br>If canceled later or in case of no show, the company has the right to charge    you 100% of the booking amount.</td>
