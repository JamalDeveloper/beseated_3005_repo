...
<script type="text/javascript">
	function deleteTable(serviceID)
	{
		jQuery.ajax({
			type: "GET",
			url: "index.php?option=com_beseated&task=yachtownerservices.deleteservice",
...
<div class="table-wrp">
	<div class="media row-fluid">
		<div class="pull-left table-img span6">
			<?php $link = JRoute::_('index.php?option=com_beseated&view=yachtownerserviceedit&detail_page=1&yacht_id='.$this->elementDetail->yacht_id.'&service_id=0&Itemid='.$Itemid); ?>
		...
		<div class="media row-fluid">
			...
			<div class="media-body span6">
	            ...
	            <div class="tbl-actn-btn">
	                ...
	                <?php $link = JRoute::_("index.php?option=com_beseated&view=yachtownerserviceedit&service_id=".$item->service_id."&detail_page=1&yacht_id=".$this->elementDetail->yacht_id."&Itemid=".$Itemid); ?>
