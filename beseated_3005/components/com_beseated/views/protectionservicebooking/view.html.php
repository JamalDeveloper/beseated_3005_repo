 ...
 * @since  0.0.1
 */
class BeseatedViewProtectionServiceBooking extends JViewLegacy
{
	protected $items;
	...
	function display($tpl = null)
	{
		...
		if(!$this->user->id)
        {
			...
			$bctParams   = BeseatedHelper::getExtensionParam();
			$link2       = 'index.php?option=com_beseated&view=protectionservicebooking&service_id='.$serviceID.'&Itemid='.$menuItem2->id;
