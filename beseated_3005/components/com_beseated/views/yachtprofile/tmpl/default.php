...
<div class="table-wrp profile-wrp">
	...
	<form class="form-horizontal prf-form data-image" enctype="multipart/form-data" method="post" accept="<?php echo JRoute::_('index.php?option=com_beseated&view=yachtprofile'); ?>">
		...
		<div class="control-group">
			<div class="controls span12">
				<input type="text" name="yacht_name" id="yacht_name" value="<?php echo $this->profile->yacht_name; ?>" placeholder="Company Name">
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<div class="controls span12">
				<input type="hidden" id="task" name="task" value="yachtprofile.save">
				<input type="hidden" id="view" name="view" value="yachtprofile">
				...
				<input type="hidden" id="yacht_id" name="yacht_id" value="<?php echo $this->profile->yacht_id;?>">
			...
			image.onload = function(){
				...
				else
				{
					...
					if(!error){
						...
						xhr.open('POST', 'index.php?option=com_beseated&task=yachtprofile.uploadImage', true);
						xhr.send(data);
						xhr.onload = function () {
							jQuery('#spinner').stop().fadeOut('fast');
							location.reload();
...
jQuery(document).ready(function($) {
	...
	var yacht_id = jQuery('#yacht_id').val();
		jQuery.ajax({
			type: "GET",
			url: "index.php?option=com_beseated&task=yachtprofile.change_currency",
			data: "&yacht_id="+yacht_id+"&currency_code="+this.value,
