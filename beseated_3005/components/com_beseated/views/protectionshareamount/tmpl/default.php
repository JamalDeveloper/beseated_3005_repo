...
$protectionBookingDetail = $this->protectionBookingDetail;
$total_price = $protectionBookingDetail->total_price;
$booking_cur_sign = $protectionBookingDetail->booking_currency_sign;
...
jQuery(document).ready(function($) 
{
    ...
    jQuery('#next').click(function(event) 
    {
      ...
      {
        if (jQuery(jQuery('.number')[index]).text() == 7)
        {
...
<div class="share-booking-amount">
        <div class="controls">
            ...
            <input type="text" id="subject" value="<?php echo $protectionBookingDetail->booking_currency_sign.' '.number_format($protectionBookingDetail->total_price); ?>" readonly>
            ...
            <form name="share" method="post" action="<?php echo JRoute::_('index.php?option=com_beseated');?>">
                ...
                <input type="hidden" id="task" name="task" value="protectionshareamount.shareGuestCountUpdate">
                <input type="hidden" id="booking_id" name="booking_id" value="<?php echo $protectionBookingDetail->protection_booking_id; ?>">
            </form>
        </div>
</div>
