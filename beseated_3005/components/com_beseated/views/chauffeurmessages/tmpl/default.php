    ...
    <div class="message-list">
        <?php foreach ($this->messages as $key => $thread):
            ...
            <div class="message-details-main" id="msg_<?php echo $thread->connection_id; ?>">
                ...
                <?php $link = JRoute::_("index.php?option=com_beseated&view=chauffeurmessagedetail&user_id=".$otherUserProfile->user_id."&connection_id=".$thread->connection_id."&Itemid=".$Itemid);?>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="modal-message">Are you sure you want to Delete this conversation?</div>
      </div>
