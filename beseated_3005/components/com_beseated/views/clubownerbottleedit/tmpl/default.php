...
<script type="text/javascript">
    jQuery(document).ready(function() {
        jQuery("#jform_price").keydown(function (e) {
...
<div class="table-wrp edit-tblwrp">
    ...
    <div class="inner-guest-wrp">
        <form class="form-horizontal tbl-editfrm" method="post" enctype="multipart/form-data" method="post" accept="<?php echo JRoute::_('index.php?option=com_beseated&view=clubownerbottles'); ?>">
            <div class="span12">
                 <h2>Add/Edit Bottle</h2>
                <div class="control-group">
                    <div class="controls">
                        <?php if(!empty($this->item->image)): ?>
                            <img id="display_bottle_image" src="<?php echo JUri::root().'images/beseated/'. $this->item->image; ?>" alt="" />
                        <?php else: ?>
                            <img id="display_bottle_image" src="images/tabl-img.jpg" alt="">
                        <?php endif; ?>
            ...
            <div class="span6">
                <div class="control-group">
                    <div class="controls">
                        <?php echo $this->form->getInput('bottle_type'); ?>
                    </div>
                </div>
            </div>
            <div class="span6">
                <?php echo $this->form->getInput('bottle_id'); ?>
                <?php echo $this->form->getInput('venue_id'); ?>
                <?php //if($this->companyProfile->licence_type != 'basic'): ?>
                    <div class="control-group">
                        <div class="controls club-add-brand_name">
                             <?php echo $this->form->getLabel('brand_name'); ?>
                            <?php echo $this->form->getInput('brand_name'); ?>
                        </div>
                    </div>
                <?php //endif; ?>
                <div class="control-group">
                ...
                <div class="control-group">
                    <div class="controls">
                        ...
                        <input type="hidden" id="task" name="task" value="clubownerbottles.save" />
                    </div>
                </div>
            </div>
        </form>
...
<script type="text/javascript">
    ...
    jQuery("#display_bottle_image").click(function() {
        ...
        function readURL(input) {
            if (input.files && input.files[0]) {
                ...
                reader.onload = function (e) {
                    jQuery('#display_bottle_image').attr('src', e.target.result);
                }
