...
//echo "<pre>";print_r($this->messages);echo "<pre/>";exit();
?>
    ...
    <div class="message-list">
        <?php foreach ($this->messages as $key => $thread):
            ...
            <div class="message-details-main" id="msg_<?php echo $thread->connection_id; ?>">
                ...
                <?php $link = JRoute::_("index.php?option=com_beseated&view=venuemessagedetail&user_id=".$otherUserProfile->user_id."&connection_id=".$thread->connection_id."&Itemid=".$Itemid);?>
