...
//echo "<pre>";print_r($this->booking);echo "<pre/>";exit();
    ...
    <div class="row-fluid book-dtlwrp">
    	<div class="span10">
            <div class="booking-inner-details">
                ...
                <div class="booking-inner-time booking-inner">
                    <span class="amount">
                        <?php echo BeseatedHelper::currencyFormat($this->booking->booking_currency_code,$this->booking->booking_currency_sign,$this->booking->price_per_hours).'/Hr';?>
                    </span>
                </div>
                <div class="booking-inner-time booking-inner">
                    <?php echo $this->booking->total_hours.' Hours Requested'; ?>
                </div>
