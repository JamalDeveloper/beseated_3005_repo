	...
	<div class="tabbable boxed parentTabs">
	    ...
	    <div class="tab-content">
	        <div class="tab-pane fade active in" id="set1">
		        <form method="post" id="inviteuser" action="<?php echo JRoute::_('index.php?option=com_beseated&view=protectionsendinvitation'); ?>">
					...
					<input type="hidden" id="task" name="task" value="protectionsendinvitation.sendInvitation">
					<input type="hidden" id="view" name="view" value="protectionsendinvitation">
	        ...
	        <div class="tab-pane fade" id="set2">
	        	...
	        	<div class="userinvite">
					...
					if ($countFacebookFriendList > 0)
					{
						...
						$alreadyInvited = BeseatedHelper::getBookedElementShareInvitations('protection',$bookingID);
					...
					<?php if (count($facebookFriendList) > 0):?>
						<form class="form-horizontal prf-form" id="invitefbuser" method="post" action="<?php echo JRoute::_('index.php?option=com_beseated&view=protectionsendinvitation'); ?>">
