...
<?php if(!$protectionBooking->is_splitted && $firstTimeShare == 0) : ?>
...
<div class="row">
    <div class="payment-request-detail">
      <div class="span6"><i class="fa fa-hourglass-start" aria-hidden="true"></i>&nbsp;&nbsp;<?php echo $protectionBooking->total_hours; ?></div>
    </div>
</div>
<div class="row">
    <div class="payment-request-detail">
...
<div class="row">
    <div class="payment-request-detail">
      ...
      <div class="span3"><?php echo $protectionBooking->booking_currency_sign.' '.number_format($protectionBooking->price_per_hours); ?></div>
    </div>
</div>
<div class="row">
    <div class="payment-request-detail">
      <div class="span6">Total Amount</div>
      <div class="span3"><?php echo $protectionBooking->booking_currency_sign.' '.number_format($protectionBooking->total_price); ?></div>
    </div>
</div>
<div class="row">
    <div class="payment-request-detail">
...
<div class="row">
    <div class="payment-request-detail">
      <?php $deposit_per = ($protectionBooking->deposit_per) ? $protectionBooking->deposit_per : '0.00'; ?>
      <div class="span9"><p><?php echo $deposit_per; ?>% Payment Required, Non-Refundable prior <?php echo $protectionBooking->refund_policy; ?> hrs</p></div>
    </div>
</div>

<div class="pay-request">
    <a href="<?php echo JUri::root().'index.php?option=com_beseated&task=payment.pay&booking_id='.$protectionBooking->protection_booking_id.'&booking_type=protection'; ?>">
        <input type="button" class="btn btn-large" name="payment" value="Pay By Credit Card">
    </a>
    <a href="<?php echo JUri::root().'index.php?option=com_beseated&view=protectionshareamount&booking_id='.$protectionBooking->protection_booking_id.'&booking_type=protection&Itemid='.$Itemid; ?>">
    <input type="button" class="btn btn-large" name="payment" value="Share Amount">
    </a>
    <input type="button" class="btn btn-large" name="payment" value="Cancel" onclick="cancelBooking(<?php echo $protectionBooking->protection_booking_id;?>,'request')">
</div>

</body>
<?php else : ?>
  <?php if($protectionBooking->total_split_count > $protectionBooking->splitted_count) : ?>
  <div class="pay-request">
  <?php else: ?>
  <div class="pay-balance-request">
  <?php endif; ?>

        <input type="text" value="<?php echo $protectionBooking->booking_currency_sign.' '.number_format($protectionBooking->remaining_amount ); ?>" readonly>
        ...
        <?php foreach ($protectionShareUserDetail as $key => $userDetail) : ?>  
          <div class="splitted-user-list">
              ...
              <a href="<?php echo JUri::root().'index.php?option=com_beseated&view=protectionshareinvitation&invitation_id='.$userDetail->protection_booking_split_id.'&booking_id='.$protectionBooking->protection_booking_id.'&Itemid='.$Itemid; ?>">
        ...
        <?php if($viewByShareUser == 0) : ?>
          <a href="<?php echo JUri::root().'index.php?option=com_beseated&task=payment.pay&booking_id='.$protectionBooking->protection_booking_id.'&booking_type=protection&pay_balance=1'; ?>">
              <input type="button" class="btn btn-large" name="payment" value="Pay Balance">
          </a>
          <?php if($protectionBooking->total_split_count > $protectionBooking->splitted_count) : ?>
          <a href="<?php echo JUri::root().'index.php?option=com_beseated&view=protectionshareinvitation&booking_id='.$protectionBooking->protection_booking_id.'&Itemid='.$Itemid; ?>">
              <input type="button" class="btn btn-large" name="payment" value="Invite Friends">
          </a>
          <?php endif;?>

          <input type="button" class="btn btn-large" name="payment" value="Cancel" onclick="cancelBooking(<?php echo $protectionBooking->protection_booking_id;?>,'booking')">
        <?php endif;?>
</div>
<?php endif; ?>
...
function cancelBooking(bookingID,type)
{
    ...
    jQuery('.cancel-booking').click(function (e) 
    {
        jQuery.ajax({
            ...
            data: "&bookingID="+bookingID+"&bookingType=protection",
