 ...
 * @since  0.0.1
 */
class BeseatedViewProtectionshareuserpay extends JViewLegacy
{
	protected $messages;
	...
	function display($tpl = null)
	{
		...
		$this->protectionBookingDetail   = $this->get('ProtectionBookingDetail');
		$this->protectionShareUserDetail = $this->get('ProtectionSharedUserDetail');
