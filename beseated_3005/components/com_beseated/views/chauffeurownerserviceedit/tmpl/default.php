...
if($page_load == 1 && $serviceID)
{
    ...
    $input->cookie->set( 'chauffeur_ser_default_img_id',  $yachtSerDefaultImg);
...
<div class="table-wrp edit-tblwrp">
    ...
    <div class="inner-guest-wrp">
        <form class="form-horizontal tbl-editfrm" method="post" enctype="multipart/form-data" method="post" accept="<?php echo JRoute::_('index.php?option=com_beseated&view=chauffeurownerservices'); ?>">
            <div class="span12">
            ...
            <div class="span6">
                ...
                <?php echo $this->form->getInput('chauffeur_id'); ?>
               <div class="control-group">
                ...
                <div class="control-group">
                    <div class="controls">
                        ...
                        <input type="hidden" id="task" name="task" value="chauffeurownerserviceedit.save" />
...
jQuery(function()
{
    ...
    var chauffeur_id    = '<?php echo $chauffeurID; ?>';
            ...
            image.onload = function()
            {
                ...
                else
                {
                    ...
                    if(!error){
                        ...
                        xhr.open('POST', 'index.php?option=com_beseated&task=chauffeurownerserviceedit.uploadServiceImage&detail_page=1&unique_code='+unique_code+'&chauffeur_id='+chauffeur_id+'&service_id='+service_id+'&Itemid='+Itemid, true);
                        xhr.send(data);
                        xhr.onload = function () 
                        {
                            jQuery('#spinner').stop().fadeOut('fast');
