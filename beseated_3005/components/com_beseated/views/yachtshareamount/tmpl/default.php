...
$yachtBookingDetail = $this->yachtBookingDetail;


$total_price        = $yachtBookingDetail->total_price;
$booking_cur_sign   = $yachtBookingDetail->booking_currency_sign;
$capacity   = $yachtBookingDetail->capacity;
...
<div class="share-booking-amount">
        <div class="controls">
            ...
            <input type="text" id="subject" value="<?php echo $yachtBookingDetail->booking_currency_sign.' '.number_format($yachtBookingDetail->total_price); ?>" readonly>
            ...
            <form name="share" method="post" action="<?php echo JRoute::_('index.php?option=com_beseated');?>">
                ...
                <input type="hidden" id="task" name="task" value="yachtshareamount.shareGuestCountUpdate">
                <input type="hidden" id="booking_id" name="booking_id" value="<?php echo $yachtBookingDetail->yacht_booking_id; ?>">
            </form>
        </div>
</div>
