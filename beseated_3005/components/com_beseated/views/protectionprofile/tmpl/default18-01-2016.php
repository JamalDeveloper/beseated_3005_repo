...
<div class="table-wrp profile-wrp">
	...
	<form class="form-horizontal prf-form" enctype="multipart/form-data" method="post" accept="<?php echo JRoute::_('index.php?option=com_beseated&view=profile'); ?>">
		...
		<div class="control-group">
			<div class="controls span4">
				<select class="music_select_box" name="music" id="music">
					...
					<?php if($this->profile->music == "House"): ?>
						<option selected="selected" value="House">House</option>
					<?php else: ?>
						<option value="House">House</option>
					<?php endif; ?>

					<?php if($this->profile->music == "Reggae"): ?>
						<option selected="selected" value="Reggae">Reggae</option>
					<?php else: ?>
						<option value="Reggae">Reggae</option>
					<?php endif; ?>

					<?php if($this->profile->music == "Salsa"): ?>
						<option selected="selected" value="Salsa">Salsa</option>
					<?php else: ?>
						<option value="Salsa">Salsa</option>
					<?php endif; ?>

					<?php if($this->profile->music == "Live music"): ?>
						<option selected="selected" value="Live music">Live music</option>
					<?php else: ?>
						<option value="Live music">Live music</option>
					<?php endif; ?>

					<?php if($this->profile->music == "Techno"): ?>
						<option selected="selected" value="Techno">Techno</option>
					<?php else: ?>
						<option value="Techno">Techno</option>
					<?php endif; ?>

					<?php if($this->profile->music == "Jazz"): ?>
						<option selected="selected" value="Jazz">Jazz</option>
					<?php else: ?>
						<option value="Jazz">Jazz</option>
					<?php endif; ?>

					<?php if($this->profile->music == "Latin"): ?>
