	...
	<form class="form-horizontal prf-form data-image" enctype="multipart/form-data" method="post" accept="<?php echo JRoute::_('index.php?option=com_beseated&view=profile'); ?>">
		...
		<div class="control-group">
			<div class="controls span12">
				<input type="text" name="protection_name" id="protection_name" value="<?php echo $this->profile->protection_name; ?>" placeholder="Company Name">
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<div class="controls span12">
				<input type="hidden" id="task" name="task" value="protectionprofile.save">
				<input type="hidden" id="view" name="view" value="protectionprofile">
				...
				<input type="hidden" id="protection_id" name="protection_id" value="<?php echo $this->profile->protection_id;?>">
			...
			image.onload = function(){
				...
				else
				{
					...
					if(!error){
						...
						xhr.open('POST', 'index.php?option=com_beseated&task=protectionprofile.uploadImage', true);
						xhr.send(data);
						xhr.onload = function () {
							jQuery('#spinner').stop().fadeOut('fast');
							location.reload();
...
jQuery(document).ready(function($) {
	...
	var protection_id = jQuery('#protection_id').val();
		jQuery.ajax({
			type: "GET",
			url: "index.php?option=com_beseated&task=protectionprofile.change_currency",
			data: "&protection_id="+protection_id+"&currency_code="+this.value,
