...
{
	$total_split_count  = 0;
	if($this->yachtBookingDetail->splitted_count)
	{
		$total_split_count = $this->yachtBookingDetail->total_split_count - $this->yachtBookingDetail->splitted_count;
	}
	elseif ($this->yachtBookingDetail->total_split_count && empty($this->yachtBookingDetail->splitted_count)) 
	{

	    $total_split_count = $this->yachtBookingDetail->total_split_count - 1;
	}
	...
	<div class="tabbable boxed parentTabs">
	    ...
	    <div class="tab-content">
	        <div class="tab-pane fade active in" id="set1">
		        <form method="post" id="shareuser" action="<?php echo JRoute::_('index.php?option=com_beseated&view=yachtshareinvitation'); ?>">
					...
					<?php if($invitationID): ?>
						<input type="hidden" id="task" name="task" value="yachtshareinvitation.replaceShareInvitee">
					<?php else: ?>
						<input type="hidden" id="task" name="task" value="yachtshareinvitation.inviteUser">
					<?php endif; ?>
					
					<input type="hidden" id="view" name="view" value="yachtshareinvitation">
	        ...
	        <div class="tab-pane fade" id="set2">
	        	...
	        	<div class="userinvite">
					...
					<?php if (count($facebookFriendList) > 0):?>
						<form class="form-horizontal prf-form" id="sharefbuser" method="post" action="<?php echo JRoute::_('index.php?option=com_beseated&view=yachtshareinvitation'); ?>">
