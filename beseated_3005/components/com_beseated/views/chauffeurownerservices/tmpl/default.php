...
<script type="text/javascript">
	function deleteTable(serviceID)
	{
		jQuery.ajax({
			type: "GET",
			url: "index.php?option=com_beseated&task=chauffeurownerservices.deleteservice",
...
<div class="table-wrp">
	<div class="media row-fluid">
		<div class="pull-left table-img span6">
			<?php $link = JRoute::_('index.php?option=com_beseated&view=chauffeurownerserviceedit&detail_page=1&chauffeur_id='.$this->elementDetail->chauffeur_id.'&service_id=0&Itemid='.$Itemid); ?>
	...
	<?php foreach ($this->items as $key => $item):?>
		...
		<div class="media-body span6">
            ...
            <div class="tbl-actn-btn">
                ...
                <?php $link = JRoute::_('index.php?option=com_beseated&view=chauffeurownerserviceedit&detail_page=1&chauffeur_id='.$this->elementDetail->chauffeur_id.'&service_id='.$item->service_id.'&Itemid='.$Itemid); ?>
