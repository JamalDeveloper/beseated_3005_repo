...
$menuItem            = $menu->getItems( 'link', 'index.php?option=com_beseated&view=protections', true );
...
<div class="wrapper">
		...
		<form action="<?php echo JRoute::_('index.php?option=com_beseated&view=protections&Itemid='.$Itemid);?>" name="adminForm" method="post" class="form-inline" id="search_form">
			...
			<div class="control-group flter-option">
					<div class="controls">
						<div class="control-group">
							...
							<?php endif; ?>
							<label for="c2"><?php echo JText::_('COM_BESEATED_PROTECTIONS_FILTER_PROTECTIONS_NEAR_ME'); ?></label>
						</div>
					</div>
			</div>
			<div class="control-group">
				...
				<div class="span4 venue_blck ">
					<div class="venue-img">
						<?php if(!empty($result->thumb_image)):?>
							<a href="<?php echo JRoute::_('index.php?option=com_beseated&view=protectioninformation&protection_id='.$result->protection_id.'&Itemid='.$menuItem->id ) ?>"><img src="<?php echo JUri::base().'images/beseated/'. $result->thumb_image; ?>" alt="" /></a>
						<?php elseif(!empty($result->image)): ?>
							<a href="<?php echo JRoute::_('index.php?option=com_beseated&view=protectioninformation&protection_id='.$result->protection_id.'&Itemid='.$menuItem->id ) ?>"><img src="<?php echo JUri::base().'images/beseated/'. $result->image; ?>" alt="" /></a>
						<?php else: ?>
							<a href="<?php echo JRoute::_('index.php?option=com_beseated&view=protectioninformation&protection_id='.$result->protection_id.'&Itemid='.$menuItem->id) ?>"><img src="images/bcted/default/banner.png" alt="" /></a>
						<?php endif; ?>
