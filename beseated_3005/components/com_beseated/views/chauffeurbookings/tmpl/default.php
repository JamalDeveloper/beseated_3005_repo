...
<script type="text/javascript">
	function removePastBooking(bookingID,userID,bookingType)
	{
		jQuery.ajax({
			url: 'index.php?option=com_beseated&task=clubbookings.deletePastBooking',
			type: 'GET',
			data: '&booking_type='+bookingType+'&user_type=venue&booking_id='+bookingID+'&user_id='+userID,
...
$resultHistoryBookings = $this->bookings['history'];
	
$resultUpcomingBookings = $this->bookings['upcomming'];
			...
			<div class="summary-list">
				<ul>
					<?php if(count($resultUpcomingBookings) > 0): ?>
						...
						<li id="booking_<?php echo $booking->chauffeur_booking_id; ?>">
							...
							<?php endif;?>
								<div class="booking-details">
									<a href="index.php?option=com_beseated&view=chauffeurbookingdetail&booking_id=<?php echo $booking->chauffeur_booking_id; ?>&Itemid=<?php echo $Itemid; ?>">
										<div class="booking-name">
											<?php echo ucfirst($booking->full_name);?>
										</div>
										<div class="booking-service-name">
											<?php echo ucfirst($booking->service_name).'&nbsp;-&nbsp;'.BeseatedHelper::currencyFormat($booking->booking_currency_code,$booking->booking_currency_sign,$booking->total_price);?>
										</div>
